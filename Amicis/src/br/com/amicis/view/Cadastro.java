...
public class Cadastro extends JFrame {
	...
	public Cadastro() {
		...
		criarUsuario.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (nome.getText().trim().isEmpty() || sobrenome.getText().trim().isEmpty() || thisUsuario.getText().trim().isEmpty() || dataNascimento.getText().trim().isEmpty() || telefone.getText().trim().isEmpty() || email.getText().trim().isEmpty()){
