...
public class Home extends JFrame {
    ...
    public Home() throws SQLException {
        ...
        novaPublicacao.setPreferredSize(new Dimension(200, 200));
    ...
    private JPanel criarPublicacaoPanel(String nome) {
		...
		textArea.setText("Pego minha caneca de café cheia, acendo meu ultimo cigarro e corro pra velha janela do quarto. Observo a noite fria e chuvosa, até parece confortável por um momento, se não fossem as dezenas de preocupações que me desmotivam a cada dia.");
